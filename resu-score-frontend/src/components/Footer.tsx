    ...
    <footer className="mt-auto border-t border-white/10 bg-black/20 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto px-6 py-12 flex flex-col lg:flex-row justify-between gap-12 lg:gap-10">
        ...
        <div className="flex flex-col gap-4 max-w-sm shrink-0">
          <Link to="/" className="flex items-center gap-2.5 w-fit transition-all group">
            ...
            <span className="text-2xl font-extrabold tracking-tight bg-gradient-to-r from-primary to-purple-400 bg-clip-text text-transparent">
              ResuScore
            </span>
          </Link>

          <p className="text-sm text-muted-foreground leading-relaxed">
            An AI-powered resume analyzer built to help you land the job&mdash;focused on ATS compatibility, content quality, and actionable improvements.
          </p>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-muted-foreground">
          <span>
            &copy; {new Date().getFullYear()} ResuScore &mdash; Developed by{" "}
            <span className="font-medium text-foreground">Vatsal Ghaghda</span>
          </span>
          <span className="flex items-center gap-1.5">
            Made with{" "}
            <Heart className="size-3.5 text-red-500 fill-red-500" aria-hidden="true" />{" "}
